  ...
  return (
    <div className='grid w-[80%] mx-auto pt-[5rem] grid-cols-1 lg:grid-cols-2 gap-10 items-center'>
      ...
      <div>
        ...
        <p className='text-white opacity-65 text-[15px] mt-[1rem]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
          Autem iste dolores quo, dolor, animi doloribus eveniet quod, architecto officiis sit corporis. 
          Commodi, incidunt placeat nesciunt provident sequi officiis repellendus est. 
          Ipsa rem quaerat provident? Nemo. Commodi, incidunt placeat nesciunt provident sequi officiis repellendus est. 
          Ipsa rem quaerat provident? Nemo.
        </p>
