  ...
  return (
    <div className='m-2 hover:bg-gray-700 transition-all duration-300 rounded-lg'>
      <div className='border-2 p-4 border-gray-700 rounded-xl'>
        ...
        <p className='text-[15px] text-white opacity-65 mt-[3rem] text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
          Doloremque consequuntur esse illum pariatur, aperiam mollitia 
          quia ea modi cumque aspernatur molestias labore iste nobis tempore!
        </p>
