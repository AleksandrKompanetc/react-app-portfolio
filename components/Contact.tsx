    ...
    <div className='pt-[5rem] pb-[3rem] bg-gray-900'>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-[2rem] items-center w-[80%] mx-auto'>
        <div>
          ...
          <h1 className='heading__primary'>Lets make your <span className='text-yellow-400'>Brand</span>{' '}
          brilliant
          </h1>
          <p className='text-[15px] text-white mt-[1rem] opacity-75'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
            Repellat tempore quaerat maiores obcaecati illo praesentium atque non eum reiciendis a.
          </p>
