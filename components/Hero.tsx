          ...
          <div>
            ...
            <div data-aos='fade-left' data-aos-delay='400'>
              <h1 className='xl:text-[50px] lg:text-[40px] sm:text-[35px] text-[25px] font-semibold leading-[2.6rem] text-white'>
                HI, I'm <span className='text-yellow-300'>Aleksandr</span>
              </h1>
              <TypeWriterEffect />
            </div>
            <p 
              data-aos='fade-up' 
              data-aos-delay='800' 
              className='mt-[1.2rem] text-15px md:text-[17px] text-[#c4cfde]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium, ad? Quisquam odit qui ipsam? 
              Est aperiam quidem eveniet, doloremque perferendis delectus tempora.
            </p>
            <div className='mt-[2rem] flex items-center space-x-6 '>
              ...
              <button 
                data-aos='zoom-out' 
                data-aos-delay='1600' 
                className='before:ease relative h-12 w-40 overflow-hidden bg-orange-600 text-white 
